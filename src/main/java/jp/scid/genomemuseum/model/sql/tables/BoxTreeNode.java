...
public class BoxTreeNode extends org.jooq.impl.UpdatableTableImpl<jp.scid.genomemuseum.model.sql.tables.records.BoxTreeNodeRecord> {
	...
	private static final long serialVersionUID = -1505633279;
	...
	@Override
	public org.jooq.Identity<jp.scid.genomemuseum.model.sql.tables.records.BoxTreeNodeRecord, java.lang.Long> getIdentity() {
		return jp.scid.genomemuseum.model.sql.Keys.IDENTITY_BOX_TREE_NODE;
	}

	@Override
	public org.jooq.UniqueKey<jp.scid.genomemuseum.model.sql.tables.records.BoxTreeNodeRecord> getMainKey() {
		return jp.scid.genomemuseum.model.sql.Keys.CONSTRAINT_5D;
	}

	@Override
	@SuppressWarnings("unchecked")
	public java.util.List<org.jooq.UniqueKey<jp.scid.genomemuseum.model.sql.tables.records.BoxTreeNodeRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<jp.scid.genomemuseum.model.sql.tables.records.BoxTreeNodeRecord>>asList(jp.scid.genomemuseum.model.sql.Keys.CONSTRAINT_5D, jp.scid.genomemuseum.model.sql.Keys.CONSTRAINT_5);
	}
