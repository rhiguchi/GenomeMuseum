...
public class MuseumExhibit extends org.jooq.impl.UpdatableTableImpl<jp.scid.genomemuseum.model.sql.tables.records.MuseumExhibitRecord> {
	...
	private static final long serialVersionUID = -1569125291;
	...
	@Override
	public org.jooq.Identity<jp.scid.genomemuseum.model.sql.tables.records.MuseumExhibitRecord, java.lang.Long> getIdentity() {
		return jp.scid.genomemuseum.model.sql.Keys.IDENTITY_MUSEUM_EXHIBIT;
	}

	@Override
	public org.jooq.UniqueKey<jp.scid.genomemuseum.model.sql.tables.records.MuseumExhibitRecord> getMainKey() {
		return jp.scid.genomemuseum.model.sql.Keys.CONSTRAINT_D;
	}

	@Override
	@SuppressWarnings("unchecked")
	public java.util.List<org.jooq.UniqueKey<jp.scid.genomemuseum.model.sql.tables.records.MuseumExhibitRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<jp.scid.genomemuseum.model.sql.tables.records.MuseumExhibitRecord>>asList(jp.scid.genomemuseum.model.sql.Keys.CONSTRAINT_D);
	}
