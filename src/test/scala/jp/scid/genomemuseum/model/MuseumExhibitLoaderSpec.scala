...
//    
//    def genbankLoad = loader.makeExhibit(exhibit, getGenbankFile).getOrElse(emptyExhibit)
//    
//    def fastaLoad = loader.makeExhibit(exhibit, getFastaFile).getOrElse(emptyExhibit)
//    
